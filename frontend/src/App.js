      ...
      <div className="max-w-md mx-auto md:max-w-2xl text-center">
        <h2 className="text-2xl text-[#ee5e5f] font-bold mb-14 pb-2 border-b border-[#eca74e4f] flex flex-col md:flex-row md:items-center md:justify-center">
          ...
          <span className="md:ml-2">
            <a
              href="https://6471f4ee6d456f727011ed5d--projectportfolio123.netlify.app/"
              target="_blank"
        ...
        <div className="md:flex">
          <div className="md:flex-shrink-0">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Train_icon.svg/1775px-Train_icon.svg.png"
              alt="Train_image"
          ...
          <div className="p-8 md:mt-8">
            ...
            <p className="mt-2 text-gray-500">
              Mumbai <i className="fa-solid fa-arrow-right mx-2"></i> Banglore
            </p>
          </div>
        </div>
        {errorMessage && (
